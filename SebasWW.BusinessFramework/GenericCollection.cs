...
{
    public abstract class GenericCollection<TObject, TEntry, TKey> 
        : GenericReadOnlyCollection<TObject, TEntry, TKey>, ICollection<TObject>
        where TEntry : class
        where TObject: GenericObject<TEntry,TKey>
    {
        protected GenericCollection(
            ...
            ObjectFactory<TObject, TEntry, TKey> factory
            )

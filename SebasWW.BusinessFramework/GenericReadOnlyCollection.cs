...
{
    public abstract class GenericReadOnlyCollection<TObject, TEntry, TKey>
...

    {
        ...
        ObjectFactory<TObject, TEntry, TKey> _factory;
        ...
        protected GenericReadOnlyCollection(BusinessManager BusinessContext, ICollection<TEntry> entrySet, Func<TEntry, TKey> keySelector, ObjectFactory<TObject, TEntry, TKey> factory)
        {

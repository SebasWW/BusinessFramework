...
{
    public class BusinessIncludableQuery<TCollection, TReadOnlyCollection, TObject, TEntry, TKey, TProperty>: BusinessQuery<TCollection, TReadOnlyCollection, TObject, TEntry, TKey>
        ...
        where TEntry : class
    {
        IIncludableQueryable<TEntry, TProperty> _includableQueryable;

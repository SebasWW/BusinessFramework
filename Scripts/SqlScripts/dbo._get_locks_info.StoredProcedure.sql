IF OBJECT_ID('[dbo].[_get_locks_info]', 'P') IS NOT NULL
	DROP PROCEDURE [dbo].[_get_locks_info]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROC [dbo].[_get_locks_info]
AS
BEGIN
/*
Данная процедура показывает информацию по блокировкам в текущей БД.
*/

DECLARE @Wait_Duration_ms INT = 1000
